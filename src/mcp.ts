...
export const TOOLS = [
  ...
  },
  {
    ...
    description:
      ...
      "月だけ・外惑星だけの条件でも引ける。\n" +
      "⚠ 太陽と一緒に水星・金星を指定するときは物理の制約がある——" +
      "**水星は太陽と同じ星座か前後 1 星座・金星は同じ星座か前後 2 星座まで**" +
      "（12 星座の端は循環＝牡羊座の隣は魚座。例: 太陽 牡羊座なら水星は 魚座 / 牡羊座 / 牡牛座 のどれか）。" +
      "その外は空に存在しないので、探さずに引数エラーで断る（太陽を指定しなければこの検査は掛からない）。\n" +
